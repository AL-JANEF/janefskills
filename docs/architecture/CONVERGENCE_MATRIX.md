...
| JS `.claude-plugin/*` | Plugin + marketplace | AES plugin manifests | Namespace `janefskills` used by existing installs | `.claude-plugin/*` (namespace kept, displayName "JANEF Forge") | KEEP |
